...
- `RAGPREP_LAYOUT_RENDER_DPI`: DPI used for layout rendering (default: `RAGPREP_RENDER_DPI`)
- `RAGPREP_LAYOUT_RENDER_MAX_EDGE`: max edge for layout rendering (default: `RAGPREP_RENDER_MAX_EDGE`)
